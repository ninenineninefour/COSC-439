...
public class el_TCPClient {
	...
	static class ClientSender extends Thread {
		...
		public void run() {
			...
			// DONE is sent as plaintext to help secure against known-plaintext attacks, since DONE is always the
			// last thing it sends. This would allow an eavesdropper to read the messages afterwards.
	...
	static class ClientReceiver extends Thread {
		...
		public void run() {
			try {
				...
				System.out.println(connection.receivePlaintext());
